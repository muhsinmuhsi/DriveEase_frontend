...
const FeaturedVehicles = () => {
  return (
    <div className='p-3 pt-10 pb-14 '>
        ...
        <div className=' justify-around pt-8  flex md:flex-row flex-wrap flex-col gap-7  items-center'>
            <div className='bg-slate-100 flex flex-col w-52 h-80 mx-5   shadow-lg rounded-2xl p-4'>
